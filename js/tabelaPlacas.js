        ...
        html: `
            <div style="font-size: 14px; display: flex; flex-direction: column; gap: 10px;">
                <div style="display: flex; align-items: center; gap: 10px;">
                    <label for="swal-input-nome" style="margin-bottom: 0; width: 70px; text-align: right;  color: black;">Nome:</label>
                    <input id="swal-input-nome" class="swal2-input" placeholder="Digite o nome" style="flex: 1; margin: 0; height: 25px;" oninput="capitalizeFirstLetterName()">
                </div>
                <div style="display: flex; align-items: center; gap: 10px;">
                    <label for="swal-input-setor" style="margin-bottom: 0; width: 70px; text-align: right;  color: black;">Setor:</label>
                    <input id="swal-input-setor" class="swal2-input" placeholder="Digite o setor" style="flex: 1;  margin: 0; height: 25px;" oninput="capitalizeFirstLetterSetor()">
                </div>
                <div style="display: flex; align-items: center; gap: 10px;">
                    <label for="swal-input-ramal" style="margin-bottom: 0; width: 70px; text-align: right;  color: black;">Ramal:</label>
                    <input id="swal-input-ramal" class="swal2-input" placeholder="Digite o ramal" type="tel" inputmode="numeric" style="flex: 1;  margin: 0; height: 25px;" oninput="validateRamal()">
                </div>
                <div style="display: flex; align-items: center; gap: 10px;">
                    <label for="swal-input-carro" style="margin-bottom: 0; width: 70px; text-align: right;  color: black;">Carro:</label>
                    <input id="swal-input-carro" class="swal2-input" placeholder="Digite o carro" style="flex: 1;  margin: 0; height: 25px;" oninput="capitalizeFirstLetterCarro()">
                </div>
                <div style="display: flex; align-items: center; gap: 10px;">
                    <label for="swal-input-cor" style="margin-bottom: 0; width: 70px; text-align: right;  color: black;">Cor:</label>
                    <input id="swal-input-cor" class="swal2-input" placeholder="Digite a cor" style="flex: 1;  margin: 0; height: 25px;" oninput="capitalizeFirstLetterCor()">
                </div>
                <div style="display: flex; align-items: center; gap: 10px;">
                    <label for="swal-input-placa" style="margin-bottom: 0; width: 70px; text-align: right;  color: black;">Placa:</label>
                    <input id="swal-input-placa" class="swal2-input" placeholder="Digite a placa" style="flex: 1;  margin: 0; height: 25px;" oninput="transformToUpperCasePlaca()">
                </div>
            </div>
        `,
            ...
            formulario.where("placa", "==", placa).get()
                .then((querySnapshot) => {
                    ...
                    Swal.fire({
                        ...
                        html: `
                        <div style="font-size: 14px; display: flex; flex-direction: column; gap: 10px; margin: 5px; padding: 0px 0px 0px 0px; ">
                            <div style="display: flex; align-items: center; gap: 10px;">
                                <label for="swal-input-nome"  style="margin-bottom: 0; width: 70px; text-align: right;  color: black;">Nome:</label>
                                <input id="swal-input-nome" class="swal2-input" style="flex: 1; margin: 0; height: 25px;" oninput="capitalizeFirstLetterName()" value="${data.nome || ''}">
                            </div>
                            <div style="display: flex; align-items: center; gap: 10px;">
                                <label for="swal-input-setor" style="margin-bottom: 0; width: 70px; text-align: right;  color: black;">Setor:</label>
                                <input id="swal-input-setor" class="swal2-input" style="flex: 1; margin: 0; height: 25px;" oninput="capitalizeFirstLetterSetor()" value="${data.setor || ''}">
                            </div>
                            <div style="display: flex; align-items: center; gap: 10px;">
                                <label for="swal-input-ramal" style="margin-bottom: 0; width: 70px; text-align: right;  color: black;">Ramal:</label>
                                <input id="swal-input-ramal" class="swal2-input" style="flex: 1; margin: 0; height: 25px;" oninput="validateRamal()" value="${data.ramal || ''}">
                            </div>
                            <div style="display: flex; align-items: center; gap: 10px;">
                                <label for="swal-input-carro" style="margin-bottom: 0; width: 70px; text-align: right;  color: black;">Carro:</label>
                                <input id="swal-input-carro" class="swal2-input" style="flex: 1; margin: 0; height: 25px;" oninput="capitalizeFirstLetterCarro()" value="${data.carro || ''}">
                            </div>
                            <div style="display: flex; align-items: center; gap: 10px;">
                                <label for="swal-input-cor" style="margin-bottom: 0; width: 70px; text-align: right;  color: black;">Cor:</label>
                                <input id="swal-input-cor" class="swal2-input" style="flex: 1; margin: 0; height: 25px;" oninput="capitalizeFirstLetterCor()" value="${data.cor || ''}">
                            </div>
                            <div style="display: flex; align-items: center; gap: 10px;">
                                <label for="swal-input-placa" style="margin-bottom: 0; width: 70px; text-align: right; color: black;">Placa:</label>
                                <input id="swal-input-placa" class="swal2-input" style="flex: 1; margin: 0; height: 25px; color: red;" oninput="transformToUpperCasePlaca()" readonly value="${data.placa || ''}">
                            </div>
                        </div>
                        `,
                        margin: 0,
